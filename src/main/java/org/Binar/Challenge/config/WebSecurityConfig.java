...
import org.Binar.Challenge.service.LoginRegisterService;
import org.Binar.Challenge.service.UserDetailsServiceImpl;
...
//                .antMatchers("/api/customer/**").hasAuthority(ERole.ROLE_MERCHANT.name())
//                .antMatchers("/api/merchant/**").hasAuthority(ERole.ROLE_CUSTOMER.name())
                .anyRequest()
                .authenticated()
                .and()
